 ...
 *
 */
public class LadderLiftUpDown extends Command {
    ...
    protected void execute() {
        // Right joystick Y
        double speedPercent = Robot.oi.getDriverController().getRawAxis(5);
        ...
        Robot.ladderLift.move(speedPercent);
    }
