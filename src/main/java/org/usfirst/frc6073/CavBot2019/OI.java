...
public class OI {
    ...
    public OI() {
        ...
        frontLiftDownButton = new JoystickButton(driverController, 1);
        frontLiftDownButton.whileHeld(new FrontLiftDown());
        frontLiftUpButton = new JoystickButton(driverController, 1);
        frontLiftUpButton.whileHeld(new FrontLiftUp());
        backLiftDownButton = new JoystickButton(driverController, 1);
        backLiftDownButton.whileHeld(new BackLiftDown());
        backLiftUpButton = new JoystickButton(driverController, 1);
        backLiftUpButton.whileHeld(new BackLiftUp());
        shootInFastButton = new JoystickButton(driverController, 1);
        ...
        hatchToggleButton = new JoystickButton(driverController, 1);
        hatchToggleButton.whileHeld(new HatchToggle());
        hatchCloseButton = new JoystickButton(driverController, 1);
        hatchCloseButton.whenPressed(new HatchClose());
        hatchOpenButton = new JoystickButton(driverController, 1);
